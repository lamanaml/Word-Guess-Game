// global variables
// --------------------------------------
  var desserts = ["cheesecake","cookies", "pie", "cake", "popsicle", "flan", "souffle", "smoothie", "pudding", "cupcake", "sundae"]; 
...
function startGame() {
  ...
  chosenWord = desserts[Math.floor(Math.random() * desserts.length)];
...
//         blanksAndSuccesses.push(userGuess)
//         document.getElementById("letterGuessed").innerHTML = blanksAndSuccesses;
...
//       } 
//       else {
//         lettersInChosenWord[j] = userGuess
//         document.getElementById("lettersRemaining").innerHTML = lettersInChosenWord.join("  ");
